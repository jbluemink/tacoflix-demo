...
namespace TacoFlixML.ConsoleApp
{
    class Program
    {
        ...
        private const string DATA_FILEPATH = @"C:\ML\movie.csv";
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"Single Prediction --> Actual value: {sampleData.Rating} | Predicted value: {predictionResult.Score}");
